...
if(isset($_GET['edit'])){
	 $id = trim($_GET['edit']);
	 $query = "SELECT Username, Password, UserLevel_tbl_id, Emp_id, CreateUser, CreateDate, Status, Username WHERE Emp_id='".$id."'";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form method="post" action="controller/userController.php" target="_self" data-toggle="validator" id="usrmng">
                        ...
                        <input id="txtUsername" title="Username must not be blank and contain only letters, numbers and underscores." type="text" required pattern="\w+" name="usernamex">

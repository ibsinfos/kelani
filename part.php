    ...
    <div id="wrapper">
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $stmt = $db_con->prepare("SELECT * FROM privileges_tbl WHERE UserLevel_tbl_id = '" . $_SESSION['userLvl'] . "' AND Form_tbl_FormID = 'partmg'");
                $stmt->execute();
                ...
                <form method="post" action="controller/partController.php" id="partmg">
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <input class="form-control col-md-8" type="text" name="txtPart" size="45" maxlength="45" required/><br/>
                            </div>
...
<script type="text/javascript">
    $('document').ready(function () {
        ...
        function submitForm() {
            var data = $("#partmg").serialize();
            $.ajax({
                type: 'POST',
                url: 'controller/partController.php',
                data: data,
                beforeSend: function () {
                    $("#msg").fadeOut();
                },

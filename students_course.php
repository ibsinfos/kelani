            ...
            <form method="post" action="controller/students_courseController.php" data-toggle="validator" id="subcou">
                ...
                <div class="row" style="padding-left: 15px;">
                    <?php if ($permissions[0]['W']){?>
                        ...
                        <input type="button" value="Update" name="btnUpdate" class="btn btn-primary" onclick="showDetails();"/>
                    <?php } else { ?>
                        <input type="submit" value="Add" name="btnAdd" class="btn btn-primary" disabled/>
                        <input type="button" value="Update" name="btnUpdate" class="btn btn-primary" onclick="showDetails();" disabled/>
                    <?php } ?>
...
<!--                <!-- /.row -->-->
<!--                <div class="row" style="padding-left: 15px;">-->
<!--                    <input name="btnUpdate" type="submit" value="Update" onclick="showDetails()" class="btn btn-primary"/>-->
<!--                    --><?php //if ($permissions[0]['W']) { ?>
